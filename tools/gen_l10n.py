...
ROWS = [
    ...
    ('c.ratelimited', 'Rate limited by Anthropic · retrying in %@', 'Anthropic 限流 · %@ 後重試', 'Limité par Anthropic · nouvelle tentative %@', 'Von Anthropic gedrosselt · erneuter Versuch %@'),
